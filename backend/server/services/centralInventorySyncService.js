    ...
    await CentralOrderItem.findOneAndUpdate(
      { store_id: store._id, external_order_item_id: externalOrderItemId },
      {
        $set: {
          ...
          status: itemStatus,
          original_daraz_status: classification.originalStatus || itemStatus,
          original_daraz_reason: classification.originalReason || returnReason,
          reason_code: classification.reasonCode || '',
          reason_label: classification.reasonLabel || '',
          mapping_confidence: classification.mappingConfidence || 'mapped',
