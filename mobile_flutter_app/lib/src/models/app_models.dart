...
class InventoryItem {
  ...
  InventoryItem copyWith({
    ...
    return InventoryItem(
      ...
      linkedSkuCount: linkedSkuCount,
      mappedSkusText: mappedSkusText,
      storesInvolved: storesInvolved,
      sourceInventoryIds: sourceInventoryIds,
    );
  }
  ...
  factory InventoryItem.fromJson(Map<String, dynamic> json) {
    ...
    return InventoryItem(
      ...
      variationName: JsonReaders.string(json, 'variation_name'),
...
class CentralOrder {
  CentralOrder({
    ...
    required this.revenueCountable,
  ...
  factory CentralOrder.fromJson(Map<String, dynamic> json) {
    ...
    return CentralOrder(
      ...
      revenueCountable: JsonReaders.boolean(json, 'revenue_countable'),
...
class CentralOrderItem {
  CentralOrderItem({
    ...
    required this.hubArrivedAt,
    required this.collectionDeadlineAt,
    required this.daysLeftToCollect,
    required this.collectionStatus,
    required this.collectionActionRequired,
    required this.collectionNotificationLevel,
  ...
  final DateTime? hubArrivedAt;
  final DateTime? collectionDeadlineAt;
  final int? daysLeftToCollect;
  final String collectionStatus;
  final bool collectionActionRequired;
  final String collectionNotificationLevel;
  ...
  factory CentralOrderItem.fromJson(Map<String, dynamic> json) {
    ...
    return CentralOrderItem(
      ...
      hubName: JsonReaders.string(json, 'hub_name', 'Islamabad I9 Center'),
      hubArrivedAt: JsonReaders.date(json, 'hub_arrived_at'),
      ...
      collectionActionRequired: JsonReaders.boolean(json, 'collection_action_required'),
      collectionNotificationLevel: JsonReaders.string(json, 'collection_notification_level', 'none'),
      collectedAt: JsonReaders.date(json, 'collected_at'),
      processingStatus: JsonReaders.string(json, 'processing_status'),
